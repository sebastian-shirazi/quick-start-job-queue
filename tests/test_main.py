...
def test_can_enqueue_a_job_defualt_priority():
    q = Queue()
    q.enqueue("123", "task", 1)
    assert q.queue == [("123", "task", 10, 1)]

def test_can_enqueue_a_job():
    q = Queue()
    q.enqueue("123", "task", 1, 5)
    assert q.queue == [("123", "task", 5, 1)]

def test_can_dequeue_a_queued_job():
    q = Queue()
    q.queue = [("123", "task", 5, 1), ("456", "task2", 10, 2)]
    assert ("123", "task", 5, 1) == q.dequeue()
    assert q.queue == [("456", "task2", 10, 2)]
...
def test_can_read_jobs_from_file():
    ...
    assert q.queue == [('b0293ea7-f8bc-4c3a-af5e-9b1d858ed18a', 'Task 1', 3, 1),
        ('5cb139e2-2344-4ede-aa4c-4ec1e940ab28', 'Task 2', 1, 2),
        ('8b0f47f2-a833-4f12-bc9e-096e49c015ad', 'Task 3', 2, 3),
        ('eda49cfe-c2f5-49f7-917d-ffc3d3111e63', 'Task 4', 3, 4),
        ('c8fd914b-8339-4ea0-907a-dc685a8f4758', 'Task 5', 2, 5),
    ]
...
def test_can_sort_queue_lifo_from_file():
    ...
    q.sort_method = "lifo"
    q.custom_sort()
    assert q.queue == [('c8fd914b-8339-4ea0-907a-dc685a8f4758', 'Task 5', 2, 5),
        ('eda49cfe-c2f5-49f7-917d-ffc3d3111e63', 'Task 4', 3, 4),
        ('8b0f47f2-a833-4f12-bc9e-096e49c015ad', 'Task 3', 2, 3),
        ('5cb139e2-2344-4ede-aa4c-4ec1e940ab28', 'Task 2', 1, 2),
        ('b0293ea7-f8bc-4c3a-af5e-9b1d858ed18a', 'Task 1', 3, 1),
        ]
...
def test_can_sort_queue_priority_from_file():
    ...
    q.custom_sort()
    assert q.queue == [('5cb139e2-2344-4ede-aa4c-4ec1e940ab28', 'Task 2', 1, 2),
        ('8b0f47f2-a833-4f12-bc9e-096e49c015ad', 'Task 3', 2, 3),
        ('c8fd914b-8339-4ea0-907a-dc685a8f4758', 'Task 5', 2, 5),
        ('b0293ea7-f8bc-4c3a-af5e-9b1d858ed18a', 'Task 1', 3, 1),
        ('eda49cfe-c2f5-49f7-917d-ffc3d3111e63', 'Task 4', 3, 4),
